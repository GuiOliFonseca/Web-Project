...
class Product {
    ...
    static async getProductMostDiscount() {
        try {
            const response = await axios.get(`${apiURL}/product/most/discount`);
            return response.data;
        } catch (error) {
            if(error.response && error.response.data)
                return error.response.data
    ...
    static async updateActivity(data) {
        try {
            const response = await axios.post(`${apiURL}/product/active`, data);
            return response.data;
        } catch (error) {
            if(error.response && error.response.data)
                return error.response.data
