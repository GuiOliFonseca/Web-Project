          ...
          <div class="flex justify-end pt-2">
            <button
              ...
              class="
                ...
                rounded-lg
                text-red-800
                hover:bg-gray-100 hover:text-red-800
                mr-2
              "
            >
              Fechar
...
export default {
  ...
  methods: {
    ...
    calculatePricePerPlate() {
      ...
      if (!this.price || !this.width || !this.height) return;
        ...
        this.pricePerPlate = (
          parseFloat(priceWithoutDot * (1 - parseFloat(this.discount) / 100)) *
    ...
    formatDiscount() {
      let v = this.discount.toString().replace(/\D/g, "");
      v = `${(v / 100).toFixed(2)}`;
      v = v.replace(/(\d)(\d{3})(\d{3}),/g, "$1.$2.$3,");
      v = v.replace(/(\d)(\d{3}),/g, "$1.$2,");
      this.discount = v;
    ...
    async updateProduct() {
      ...
      this.discount != this.pastDiscount &&
      !(this.discount == 0 && !this.pastDiscount)
        ? (data["discount"] =
            parseFloat(this.price) -
              parseFloat(this.price) * (1 - parseFloat(this.discount) / 100) ||
            0)
        : undefined;
      ...
      if (material.success) {
        ...
        !(this.discount == 0 && !this.pastDiscount)
          ? (data["discount"] =
              parseFloat(this.price) -
                parseFloat(this.price) *
                  (1 - parseFloat(this.discount) / 100) || 0)
          : undefined;
  ...
  async created() {
    ...
    if (product.success) {
      ...
      this.price = product.product.price.toString().replace(".", ",");
      ...
      this.price = parseFloat(this.price).toLocaleString("pt-br", {
        style: "currency",
        currency: "BRL",
      });
      this.moneyFormat();
