  ...
  <div class="flex justify-center items-center h-screen bg-gray-900 px-6">
    <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
      <div class="flex justify-center items-center">
        <img class="h-8 w-8 mr-1" src="https://system-photos.s3.sa-east-1.amazonaws.com/iStones-Logo.svg" alt="iStones" />
        <span class="text-red-800 font-semibold text-2xl">Stones</span>
      </div>
      <form class="mt-4" @submit.prevent="savePassword">
        <div class="mb-1">
          ...
          <input id="newPassword"
            ...
            required
            v-model="password"
            class="text-sm sm:text-sm w-full border rounded text-gray-600 placeholder-gray-500 focus:border-red-800 focus:outline-none py-2 px-4"/>
        </div>
        <div class="mb-1">
          <label
            class="block text-gray-600 text-sm font-bold mb-2"
          ...
          <input id="newPassword"
            ...
            class="text-sm sm:text-sm w-full border rounded text-gray-600 placeholder-gray-500 focus:border-red-800 focus:outline-none py-2 px-4"/>
          <small :hidden="passwordMissMatch" class="text-red-800"
            >Senha diferentes!</small
          >
        </div>
        <div class="mt-6">
          <button
            :disabled="!passwordMissMatch || blockAction"
            type="submit"
            class="transition duration-150 py-2 px-4 bg-red-800 hover:bg-red-900 text-white font-bold border-b-4 border-red-900 focus:outline-none rounded w-full"
          >
            Alterar a senha
          </button>
