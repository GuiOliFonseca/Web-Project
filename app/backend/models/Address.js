...
class Address {
    ...
    static async delete(id) {
        try {
            ...
            const existAddress = await this.findOne(id);
            
            return existAddress.success ? { success: false, message: 'Endereço não deletado!' } : { success: true, message: 'Endereço deletado!' };
        } catch (error) {
            Message.warning(error);
