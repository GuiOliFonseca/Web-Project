...
class Salesman {
    static async findOne(id, ignore = false) {
        try {
            ...
            if (ignore) {
                ...
                salesman = await knex.select('tb_salesman.id as id_salesman', 'tb_user.id as id_user', 'business_name', 'cnpj', 'tb_salesman.is_deleted', 'tb_salesman.id_address', 'tb_salesman.created_at', 'tb_salesman.updated_at', 'name', 'surname', 'email', 'tel', 'type', 'birthdate' )
                    .from('tb_salesman')
    ...
    static async findAll(page) {
        try {
            const salesman = await knex.select('tb_salesman.id as id_salesman', 'tb_user.id as id_user', 'business_name', 'cnpj', 'tb_salesman.is_deleted', 'tb_salesman.created_at', 'tb_salesman.updated_at', 'name', 'surname', 'email', 'tel', 'type', 'birthdate' )
                .from('tb_salesman')
                .innerJoin('tb_user', 'tb_salesman.id_user', '=', 'tb_user.id')
