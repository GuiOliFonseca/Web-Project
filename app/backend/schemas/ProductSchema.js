...
const createValidate = () => {
    return Joi.object().keys({
        ...
        id_category: Joi.number().integer().min(1).required().messages({
            'number.integer': 'Id category deve ser um inteiro',
            'number.min': 'Id category não pode ser menor que 1',
            'number.empty': 'Id category não pode ser vazio',
            'any.required': 'Id category é obrigatório'
        }),
...
const updateValidate = () => {
    return Joi.object().keys({
        ...
        id_category: Joi.number().integer().min(1).messages({
            'number.integer': 'Id category deve ser um inteiro',
            'number.min': 'Id category não pode ser menor que 1'
        }),
